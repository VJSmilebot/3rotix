      ...
      <div className="relative min-h-screen bg-black text-white overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 py-32">
          ...
          <p className="max-w-3xl text-lg text-gray-300 mb-8">
            You can reach us directly via <a href="mailto:hello@3rotix.com" className="underline text-pink-500">hello@3rotix.com</a> — or just hit us up in the Telegram group.
          </p>
