...
const TOOLS = [
  ...
  { title: 'XP & Perks', desc: 'Humane gamification: recognition > paywalls.', href: '/gamification', status: 'live' },
  ...
  { title: 'Member-Only Access', desc: 'Grant access with simple passes. No lock-ins.', href: '/platform', status: 'live' },
  { title: 'Creator Dashboard', desc: 'Uploads, live controls, analytics, safety—one place.', href: '/creator', status: 'live' },
  { title: 'Creator Squads', desc: 'Creator led community of fans and supporters ', href: '/squads', status: 'live' },
  { title: 'Gamification System', desc: 'Comprehensive XP/Achievement system for rewarding and engaging users, squads, and creators.', href: '/creator', status: 'live' },
];
